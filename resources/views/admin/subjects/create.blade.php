                    ...
                    <form action="{{ route('admin.subjects.store') }}" method="POST" id="subjectForm">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('category') is-invalid @enderror" 
                                                        ...
                                                        <option value="general_education" {{ old('category') === 'general_education' ? 'selected' : '' }}>General Education</option>
                                                    </select>
                                                    @error('category')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control @error('lecture_hours') is-invalid @enderror" 
                                                           id="lecture_hours" name="lecture_hours" value="{{ old('lecture_hours', 3) }}" 
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control @error('laboratory_hours') is-invalid @enderror" 
                                                           id="laboratory_hours" name="laboratory_hours" value="{{ old('laboratory_hours', 0) }}" 
                                                           min="0" max="20" step="0.5">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="has_laboratory" 
                                                       name="has_laboratory" value="1" {{ old('has_laboratory') ? 'checked' : '' }}>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div id="prerequisite_inputs"></div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function searchPrerequisites() {
        ...
        fetch(`/admin/subjects/search?q=${encodeURIComponent(query)}`)
    ...
    // Auto-generate subject code based on department and category
    ...
    function generateSuggestedCode() {
        ...
        if (dept && category) {
            ...
            const categoryCode = category === 'core' ? '1' : 
                               category === 'major' ? '2' : 
                               category === 'minor' ? '3' : 
                               category === 'elective' ? '4' : '5';
            
            if (!codeInput.value) {
                codeInput.placeholder = `e.g., ${deptCode}${categoryCode}01`;
            }
        }
    }
    
    departmentInput.addEventListener('input', generateSuggestedCode);
    categorySelect.addEventListener('change', generateSuggestedCode);
});
</script>
@endpush
@endsection